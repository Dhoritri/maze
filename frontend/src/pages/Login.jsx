  ...
  return (
    <div className="min-h-[88vh] flex items-center justify-center py-12">
      <div className="w-full max-w-sm">
        ...
        {/* Google button — functional when VITE_GOOGLE_CLIENT_ID is set, visible always */}
        {hasGoogle ? (
          <GoogleLoginButton
          ...
          <button
            type="button"
            onClick={() => toast.info("Add VITE_GOOGLE_CLIENT_ID to your .env to enable Google Sign-in")}
